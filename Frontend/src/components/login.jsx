  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data?.user?.role) {
        ...
        console.error("User role not found:", data);
      }
    } catch (error) {
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-stone-900 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          <div className="mb-8">
            ...
            <h1 className="text-5xl font-light mb-4 tracking-wider">ATELIER</h1>
            <p className="text-stone-400 text-lg font-light leading-relaxed max-w-md">
              Crafted experiences for discerning individuals who appreciate the
              finer things.
            </p>
          </div>
          <div className="mt-16">
            <div className="w-24 h-px bg-stone-700 mb-4"></div>
            <p className="text-stone-500 text-sm font-light">Est. 2024</p>
          </div>
        </div>
        <div
